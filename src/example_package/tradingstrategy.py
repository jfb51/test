...
class TradingStrategy:
    def __init__(self, match_id, series_id, match_row, historic_match_data, career_bowling_data, career_batting_data,
                 wicket_model, runs, wms, nbs, bowling_models, num_sims,
        ...
        self.match = HistoricMatchSimulator(match_id, match_row, historic_match_data, career_bowling_data,
                                            career_batting_data, wicket_model, runs, wms, nbs, bowling_models)
