class Bowler:
    ...
    def insert_initial_stats(self, current_match_stats):
        self.current_match_stats = current_match_stats[self.bowler_in_game_attributes]
...
class Batter:
    ...
    def insert_initial_stats(self, current_match_stats):
        self.current_match_stats = current_match_stats[self.batter_in_game_attributes]
